...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "v7_multitask_model_fix"
...
#define AI_NETWORK_IN_1_SIZE        (60)
#define AI_NETWORK_IN_1_SIZE_BYTES  (240)
...
#define AI_NETWORK_OUT_2_CHANNEL     (7)
#define AI_NETWORK_OUT_2_SIZE        (7)
#define AI_NETWORK_OUT_2_SIZE_BYTES  (28)
#define AI_NETWORK_OUT_3_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_OUT_3_CHANNEL     (3)
#define AI_NETWORK_OUT_3_SIZE        (3)
#define AI_NETWORK_OUT_3_SIZE_BYTES  (12)

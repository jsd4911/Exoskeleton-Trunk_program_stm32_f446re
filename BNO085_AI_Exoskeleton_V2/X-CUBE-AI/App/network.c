...
#define AI_NETWORK_MODEL_SIGNATURE     "0x051e2061abb081faab59eed64dffc95c"
...
#define AI_TOOLS_DATE_TIME   "2026-05-10T14:13:54+0800"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  3, 0x0,
  AI_SHAPE_INIT(4, 1, 2, 1, 3), AI_STRIDE_INIT(4, 4, 4, 8, 8),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 2, 1, 3, 16), AI_STRIDE_INIT(4, 4, 8, 128, 128),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x0,
  AI_SHAPE_INIT(4, 1, 2, 1, 10), AI_STRIDE_INIT(4, 4, 4, 8, 8),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  7, 0x0,
  AI_SHAPE_INIT(4, 1, 10, 1, 2), AI_STRIDE_INIT(4, 4, 4, 40, 40),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  10, 0x0,
  AI_SHAPE_INIT(4, 80, 32, 1, 1), AI_STRIDE_INIT(4, 4, 320, 10240, 10240),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 11344, 1, 1),
    11344, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 552, 1, 1),
    552, NULL, NULL),
  ...
  &input_Transpose_layer, 0xf8bb0bfb, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_output_array.data = AI_PTR(g_network_activations_map[0] + 72);
    input_output_array.data_start = AI_PTR(g_network_activations_map[0] + 72);
    input_Transpose_output_array.data = AI_PTR(g_network_activations_map[0] + 152);
    input_Transpose_output_array.data_start = AI_PTR(g_network_activations_map[0] + 152);
    conv1d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 128);
    conv1d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
    conv1d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 0);
    conv1d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    conv1d_output_array.data = AI_PTR(g_network_activations_map[0] + 232);
    conv1d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 232);
    linear_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    linear_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv1d_bias_array.data = AI_PTR(g_network_weights_map[0] + 384);
    conv1d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 384);
    linear_weights_array.format |= AI_FMT_FLAG_CONST;
    linear_weights_array.data = AI_PTR(g_network_weights_map[0] + 448);
    linear_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 448);
    linear_bias_array.format |= AI_FMT_FLAG_CONST;
    linear_bias_array.data = AI_PTR(g_network_weights_map[0] + 10688);
    linear_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 10688);
    output_weights_array.format |= AI_FMT_FLAG_CONST;
    output_weights_array.data = AI_PTR(g_network_weights_map[0] + 10816);
    output_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 10816);
    output_bias_array.format |= AI_FMT_FLAG_CONST;
    output_bias_array.data = AI_PTR(g_network_weights_map[0] + 11328);
    output_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 11328);
    return true;
  }
